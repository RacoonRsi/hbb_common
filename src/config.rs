...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("116.203.52.248".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Assistencia CompArt".to_owned());
...
pub const RS_PUB_KEY: &str = "zVb4+91030NUGfXgmm33k+zQ0+ak9o2DBzBIZjk8xv8=";
